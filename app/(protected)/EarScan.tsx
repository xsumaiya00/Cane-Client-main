...
import { Brain, Ear, EyeIcon, EyeOffIcon } from "lucide-react-native";
...
export default function EarScan() {
  ...
  const EarSized = () => <Ear size={24} color="black" />;
      ...
      {showCountdownText ? (
        ...
        <Card variant="outline" className="w-96 py-6">
          <HStack className="text-xl flex items-center space-x-2 pb-2">
            <Icon as={EarSized} />
            <Heading className="pl-4">Ear Signals</Heading>
          </HStack>
          ...
          {payload ? (
            ...
            <>
              <Text className="text-sm text-typography-500">
                Scan your brain waves with Ear device
              </Text>
